...
//    }
     ...
     * @author jiqinlin
     */
    public final static boolean isNoZeroDigits(String str) {
        return match(str, "^[1-9]*$");
    }
    /**
     * 只能输入整数
     *
     ...
     * @author jiqinlin
     */
    public final static boolean isZhengShuDigits(String str) {
